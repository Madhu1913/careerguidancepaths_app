...
class _astrounautState extends State<astrounaut>  with SingleTickerProviderStateMixin{
  List _astrounaut=[];
  ...
  Widget build(BuildContext context) {
    return Hero(tag: 017, child: SafeArea(
      child: Scaffold(
        body: Stack(
          children: [
            Container(
