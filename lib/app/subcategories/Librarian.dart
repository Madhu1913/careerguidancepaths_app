...
class _librarianState extends State<librarian>  with SingleTickerProviderStateMixin{
  List _librarian=[];
  ...
  Widget build(BuildContext context) {
    return Hero(tag: 021, child:SafeArea(
      child: Scaffold(
        body: Stack(
          children: [
            Container(
