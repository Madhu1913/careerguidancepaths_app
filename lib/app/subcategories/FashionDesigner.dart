...
class _fashionDesignerState extends State<fashionDesigner>  with SingleTickerProviderStateMixin{
  List _fashionDesigner=[];

  Future<void> readJson() async {
    final String response = await rootBundle.loadString('assets/data.json');
    final data = jsonDecode(response);
    setState(() {
      _fashionDesigner=data["FASHION DESIGNER"];
    });
  }
  ...
  Widget build(BuildContext context) {
    return Hero(tag: 019, child:SafeArea(
      child: Scaffold(
        body: Stack(
          children: [
            // Container(
            ...
            Positioned(
              ...
              child: SizedBox(
                ...
                child: ListView.builder(
                  // shrinkWrap: true,
                    itemCount: _fashionDesigner.length,
