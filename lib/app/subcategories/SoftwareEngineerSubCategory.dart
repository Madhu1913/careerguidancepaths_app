import 'package:careerguidancepaths_app/app/StaticPaths/SoftwareEngineerStaticPaths.dart';
...
class _softwareEngineerSubCategoriesState extends State<softwareEngineerSubCategories>with SingleTickerProviderStateMixin {
                          ...
                          child: Column(
                            children: [
                              SizedBox(
                                height: 22.h,
                                child: Card(
                                  child: FadeInImage.assetNetwork(placeholder: 'assets/giphy.gif', image:  widget.sofEngSub[i]["url"],
                                    fit: BoxFit.cover,),
                                ),
                              ),
                              SizedBox(
