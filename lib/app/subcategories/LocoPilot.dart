...
class _locoPilotState extends State<locoPilot>  with SingleTickerProviderStateMixin{
  List _locoPilot=[];
  ...
  Widget build(BuildContext context) {
    return Hero(tag: 010, child:SafeArea(
      child: Scaffold(
        body: Stack(
          children: [
            Container(
