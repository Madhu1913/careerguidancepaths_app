...
class _archeologistState extends State<archeologist>  with SingleTickerProviderStateMixin{
  List _archeologist=[];
  ...
  Future<void> readJson() async {
    ...
    setState(() {
      _archeologist=data["ARCHEOLOGIST"];
    });
  }
  ...
  Widget build(BuildContext context) {
    return Hero(tag: 018, child: SafeArea(
      child: Scaffold(
        body: Stack(
          children: [
            // Container(
            ...
            Positioned(
              ...
              child: SizedBox(
                ...
                child: ListView.builder(
                  // shrinkWrap: true,
                    itemCount: _archeologist.length,
